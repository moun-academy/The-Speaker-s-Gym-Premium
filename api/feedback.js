        ...
        messages: [
          {
            ...
            content: [
              ...
              '',
              'What you did well:',
              '• [Specific strength with metrics reference]',
              '• [Specific strength with metrics reference]',
              '• [Specific strength with metrics reference]',
              '',
              'What to improve:',
              '• [Specific area with metrics reference]',
              '• [Specific area with metrics reference]',
              '• [Specific area with metrics reference]',
              '',
              'Next speech focus:',
              '• [One actionable goal based on the data]',
              '',
              'Be specific and reference the actual metrics (pace, pauses, filler word count).',
